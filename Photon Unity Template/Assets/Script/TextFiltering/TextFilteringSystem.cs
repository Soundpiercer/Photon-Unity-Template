...
/// <summary>
/// Text Filtering System using Aho-Corasick Algorithm and Trie.
/// </summary>
#region TestBed Template
public class TextFilteringSystem
{
    private void TestBedTemplate()
    {
        Trie trie = new Trie();
        string text = "Hello this beautiful World!";

        // Assumes that censored words are added from CSV
        trie.Add("Hello");
        trie.Add("World");
        ...
        // Detects all occurrences that input string matchs the Trie Nodes.
...
public class Trie<T, TValue>
{
    ...
    public bool Contains(IEnumerable<T> text)
    {
        var node = root;
